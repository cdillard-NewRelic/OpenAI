...
public protocol OpenAIProtocol {
    ...
    **/
    func completions(query: CompletionsQuery, completion: @escaping (Result<(CompletionsResult, [AnyHashable: Any]?), Error>) -> Void)
    ...
    **/
    func images(query: ImagesQuery, completion: @escaping (Result<(ImagesResult, [AnyHashable: Any]?), Error>) -> Void)
    ...
    /**
     ...
     - Parameters:
       ...
       - completion: A closure which receives the result when the API request finishes. The closure's parameter, `Result<ImagesResult, Error>`, will contain either the `ImagesResult` object with the generated images, or an error if the request failed.
    **/
    func imageEdits(query: ImageEditsQuery, completion: @escaping (Result<(ImagesResult, [AnyHashable: Any]?), Error>) -> Void)
    ...
    /**
     ...
     - Parameters:
       ...
       - completion: A closure which receives the result when the API request finishes. The closure's parameter, `Result<ImagesResult, Error>`, will contain either the `ImagesResult` object with the generated images, or an error if the request failed.
    **/
    func imageVariations(query: ImageVariationsQuery, completion: @escaping (Result<(ImagesResult, [AnyHashable: Any]?), Error>) -> Void)
    ...
    **/
    func embeddings(query: EmbeddingsQuery, completion: @escaping (Result<(EmbeddingsResult, [AnyHashable: Any]?), Error>) -> Void)
    ...
    **/
    func chats(query: ChatQuery, completion: @escaping (Result<(ChatResult, [AnyHashable: Any]?), Error>) -> Void)
    ...
    **/
    func edits(query: EditsQuery, completion: @escaping (Result<(EditsResult, [AnyHashable: Any]?), Error>) -> Void)
    ...
    **/
    func model(query: ModelQuery, completion: @escaping (Result<(ModelResult, [AnyHashable: Any]?), Error>) -> Void)
    ...
    **/
    func models(completion: @escaping (Result<(ModelsResult, [AnyHashable: Any]?), Error>) -> Void)
    ...
    **/
    func moderations(query: ModerationsQuery, completion: @escaping (Result<(ModerationsResult, [AnyHashable: Any]?), Error>) -> Void)
     ...
     **/
    func audioTranscriptions(query: AudioTranscriptionQuery, completion: @escaping (Result<(AudioTranscriptionResult, [AnyHashable: Any]?), Error>) -> Void)
     ...
     **/
    func audioTranslations(query: AudioTranslationQuery, completion: @escaping (Result<(AudioTranslationResult, [AnyHashable: Any]?), Error>) -> Void)
}
